...
func reviewFixPrompt(leadIn, prNumber string) string {
	...
	return fmt.Sprintf(
		"%s "+
			...
			"End every reply body with the line %s so klaus doesn't mistake your reply for new review feedback.\n"+
		...
		leadIn, prNumber, prNumber, AgentReplyMarker, AgentReplyMarker,
